...
public class Publicaciones_v01 {
    ...
    public static void main(String[] args) {
        ...
        //si quiero imprimir especificamente de la otra liberia 
        publicaciones[0] = new pe.edu.pucp.inf30.sesiones.publicaciones01.publicaciones.estandardAPA.Articulo("A relational model of data for large shared data banks", "Codd, Edgar Frank", 1970, "Communications of the ACM", 13, 6, "junio");
        ...
        publicaciones[2] = new Tesis("A system of logic based on ordinals", "Turing, Alan Mathison", 1938, Clase_de_Tesis.DOCTORADO, 
                                "Departamento de Matemáticas", "Universidad de Princeton", "Princeton", "NJ");                
