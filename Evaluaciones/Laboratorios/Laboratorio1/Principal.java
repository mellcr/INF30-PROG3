...
public class Principal{
	public static void main(String[] args) throws Exception{
		...
		Curso curso1 = new Curso("LENGUAJE DE PROGRAMACION 2", "INF282", 'P', 
			1500.00, 4, 5, sdf.parse("20-03-2023"), sdf.parse("08-07-2023"), DiaSemana.Martes, LocalTime.of(8,00,00), LocalTime.of(11,00,00));
		//Creamos dos talleres de la sede
		Taller taller1 = new Taller("PYTHON PARA INVESTIGACION CUANTITATIVA","TAL725",'V', 500.00, sdf.parse("28-03-2023"),LocalTime.of(13,00,00),
